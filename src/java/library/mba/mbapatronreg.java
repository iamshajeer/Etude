 ...
 * @author Shajeer
 */
public class mbapatronreg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Mbapatron m = new Mbapatron(uid, uname, dob, address, place, pincode, phone, email, doj, batch, rollnumber, b, null, null);
            s.save(m);
            t.commit();
            f.delete();
            ...
            Mbainbox mi = new Mbainbox(m, mail, 0, sysdate, subject);
            ses.save(mi);
            tr.commit();
            ses.close();
            s.close();
