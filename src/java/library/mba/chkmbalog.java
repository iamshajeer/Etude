 ...
 * @author Shajeer
 */
public class chkmbalog extends HttpServlet {
    ...
    if(de.getLid().equals(uid) && de.getDptname().equals("mba") )
        {
    ...
    if(flag){
     ...
     request.getRequestDispatcher("mba.jsp").forward(request, response);
        ...
        response.sendRedirect("loginform/mbalogin.jsp");
    out.println("Login failed");
        ...
        /*try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet chkmbalog</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet chkmbalog at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
