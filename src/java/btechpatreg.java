 ...
 * @author Shajeer
 */
public class btechpatreg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Btechpatron m = new Btechpatron(uid, uname, dob, address, place, pincode, phone, email, doj, batch, rollnumber);
