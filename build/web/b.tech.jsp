<%-- 
    Document   : b.tech
    Created on : Apr 4, 2013, 7:22:18 PM
    Author     : Shajeer
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="textsearch.focus();">
        <div id="content">
            ...
            <div id="menu">
                <ul>
                    <li id="button1"><a href="b.tech.html" title="">Home</a></li>
        ...
        <div id="main"> 
            ...
            <div id="left">
                <div id="lefttop">
                    ...
                    <h3>Circulation</h3>
                    <form action="userforadminbtech.jsp">
                    <div>
                    ...
                    <div id="partners">
                        <ul>
                            <li id="regform/btechpatronreg" onclick="changeFrame(this.id)"><a href="#">Patrons Registration</a></li>
                            <li id="regform/btechbookreg" onclick="changeFrame(this.id)"><a href="#">Books Registraion</a></li>
                            <li><a href="#">Journals Registraion</a></li>		
                        </ul>
                    </div>
                    <br />
                    <br />
