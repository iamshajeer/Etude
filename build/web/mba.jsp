        ...
        <div id="main"> 
            ...
            <div id="left">
                <div id="lefttop">
                    ...
                    <div id="partners">
                        <ul>
                            <li id="regform/mbapatronreg" onclick="changeFrame(this.id)"><a href="#">Patrons Registration</a></li>
                            <li id="regform/mbabookreg" onclick="changeFrame(this.id)"><a href="#">Books Registration</a></li>
                    ...
                    <div id="partners">
                        <ul>
                            <li id="updatereg/mbapatronupd" onclick="changeFrame(this.id)"><a href="#">Patrons Details</a></li>
                            <li id="updatereg/mbabookupd" onclick="changeFrame(this.id)"><a href="#">Books Details</a></li>
