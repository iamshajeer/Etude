...
<%@page import="library.Mbareserv"%>
<%@page import="library.Mbapatron"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body  onload="changeFrame('circulation/mcausercircluation');">
        <div id="content">
            ...
            <div id="menu">
                <ul>
                    <li id="button1"><a href="mba.jsp" title="">Home</a></li>
                    ...
                    <div id="partners">
                        <ul>
                            <%
                                ...
                                String hqls = "from Mbareserv where uid=:uid";
                                List li = s.createQuery(hqls).setString("uid", uid).list();
                                Iterator iterator = li.iterator();
                                int c=0;
                                Mbareserv mi = null;
                                while (iterator.hasNext()) {
                                    mi = (Mbareserv) iterator.next();
                                    c++;
                                }
                            %>
                            <li id="reservation/mbauserreservadmin" onclick="changeFrame(this.id)"><a href="#">Reserved books&nbsp;<%if(c>0){%><span id="count"><%}%>(<%=c%>)</span></a></li>
                            <li id="message/mbamsg" onclick="changeFrame(this.id)"><a href="#">Send Message</a></li>
                            <li id="circulation/mcbusercircluation"  onclick="changeFrame(this.id)"><a href="#">Book Renew Date</a></li>
