        ...
        <div id="main">
            <div id="indexright">
                <div id="righttop">
                    ...
                    <center>
                    <form action="../chkadminlog" method="post">
...
<div id="categories">
                        <ul id="quotes">
                           Administrator can control the whole web application, he can change department and librarian details. he can give login credentials to librarian.
                        </ul>
                    </div>
