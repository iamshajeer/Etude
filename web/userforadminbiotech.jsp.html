...
<div id="menu">
		<ul>
			<li id="button1"><a href="user.html" title="">Home</a></li>
...
<!--code for iframe begin-->
 ...
 <iframe align="middle" scrolling="no" id="myframe" src="circulation/biotechusercirculation.jsp" frameborder="0" ><h>
			...
			<div id="categories">
				<ul>
				       <form id="form1" method="post" action="">
				         <p>
				           <input type="image" name="photo" id="photo" src="images/Rashid Meppadi.jpg" />
			             </p>
			           </form>
				     </li>					
				</ul>
